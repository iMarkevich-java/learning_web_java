				...
				<div class="main">
					...
					<div class="row">
						...
						<form action="edit-project" method="post">
						    <label>ID:</label>
						    <div class="row">
							<input name="updateProjectIdParam" type="text" readonly value="${projectIdParam}"/>
							</div>
							<label>Project budget:</label>
							<div class="row">
							<input name="updateProjectBudgetParam" type="text" value="${projectBudgetParam}"/>
							</div>
							<label>Project name:</label>
							<div class="row">
							<input name="updateProjectNameParam" type="text" value="${projectNameParam}"/>
							</div>
							<label>Project time limit:</label>
							<div class="row">
							<input name="updateProjectTimeLimitParam" type="text" value="${projectTimeLimitParam}"/>
							</div>
							<label>Project deadline:</label>
							<div class="row">
							<input name="updateProjectDeadlineParam" type="text" value="${projectDeadlineParam}"/>
							</div>
